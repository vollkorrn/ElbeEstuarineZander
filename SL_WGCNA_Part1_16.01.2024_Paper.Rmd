...
Excluded sampes: 
"SLSU21MGEB5" outlier in Euclidean-Distance clustering
"SLSU21SSEB6", doubble outlier from the group in Liver & Gill
"SLSU21MGEB3", doubble outlier from the group in Liver & Gill
Compare 4.2.1 

```{r,  message=FALSE,warning=FALSE, fig.width=12, fig.height=12}
#Problems with Markdown html output
replayPlot(WGCNA_RNA_Gill$Samples_RNA_Gill_All$SampleClusteringTreePlot)
replayPlot(WGCNA_RNA_Gill$Samples_RNA_Gill$SampleClusteringTreePlot)
...
#######################
  ...
  replayPlot(SampleClusteringTreePlot)
...
```{r,  message=FALSE,warning=FALSE, fig.width=12, fig.height=12}
#Problem with the Markdown Html output
replayPlot(WGCNA_RNA_Liver$Samples_RNA_Liver_All$SampleClusteringTreePlot)
replayPlot(WGCNA_RNA_Liver$Samples_RNA_Liver$SampleClusteringTreePlot)
