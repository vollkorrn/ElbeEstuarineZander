...
ifelse(!dir.exists(file.path(GitClonePath, "SL_Output_16S")), dir.create(file.path(GitClonePath, "SL_Output_16S")), FALSE)
ifelse(!dir.exists(file.path(GitClonePath, "SL_Output_RNA")), dir.create(file.path(GitClonePath, "SL_Output_RNA")), FALSE)
ifelse(!dir.exists(file.path(GitClonePath, "SL_Output_RNA")), dir.create(file.path(GitClonePath, "SL_Output_RNA")), FALSE)
ifelse(!dir.exists(file.path(GitClonePath, "SL_Plots")), dir.create(file.path(GitClonePath, "SL_Plots")), FALSE)
```
